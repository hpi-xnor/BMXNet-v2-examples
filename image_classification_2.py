...
quant = parser.add_argument_group('Quantization/Binarization', 'parameters for binary/quantized models')
quant.add_argument('--bits', type=int, default=1,
                   help='number of weight bits')
quant.add_argument('--bits-a', type=int, default=1,
                   help='number of bits for activation')
quant.add_argument('--activation-method', type=str, default='det_sign',
...
quant.add_argument('--weight-quantization', type=str, default='det_sign',
                   choices=['det_sign', 'dorefa', 'identity', 'approx_sign'],
                   help='choose weight quantization')
quant.add_argument('--clip-threshold', type=float, default=1.0,
    ...
    if opt.plot_network is not None:
        ...
        with open('{}.txt'.format(opt.plot_network), 'w') as f:
            with redirect_stdout(f):
                mx.viz.print_summary(sym, shape={"data": (1, 3, 224, 224)}, quantized_bitwidth=opt.bits)
